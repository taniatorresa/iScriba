...
var routes = [{
    ...
    path: 'jstree',
        component: resolve => require(['./components/jstree.vue'], resolve),
        meta: {
        title: "jstree",
            breadcrumb: `<li><a href="index.html"><i class="ti-home"></i> Dashboard</a></li><li><a>Forms</a></li><li><a>Features</a></li></li><li><a href="#/jstree">jstree</a></li>`
    }
},{
        path: 'form_layouts',
