                            ...
                            <div class="text-left">
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-primary button_normal" data-style="expand-left">Expand-left
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-primary button_normal" data-style="expand-right">Expand-right
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-primary button_normal" data-style="expand-up">Expand-up
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-primary button_normal" data-style="slide-down">Slide-down
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-primary button_normal" data-style="contract">Contract
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-primary button_normal" data-style="zoom-in">Zoom-in
                                        </button>
                                    </div>
                                </div>
                                <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-info button_normal" data-style="slide-left"><i class="fa ti-arrow-circle-left" aria-hidden="true"></i> Slide-left
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-info button_normal" data-style="slide-right">Slide-right <i class="fa ti-arrow-circle-right" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-info button_normal" data-style="slide-up">Slide-up <i class="fa ti-arrow-circle-up" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-info button_normal" data-style="contract"><i class="fa ti-filter" aria-hidden="true"></i> Contract
                                        </button>
                                    </div>
                                    <div class="col-md-2 col-sm-4">
                                        <button class="ladda-button btn btn-info button_normal" data-style="zoom-out"><i class="fa ti-zoom-out" aria-hidden="true"></i> Zoom-out
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <button class="ladda-button btn btn-warning btn-lg button_normal" data-style="expand-right">Large
                                                </button>
                                            </div>
                                            <div class="col-md-4">
                                                <button class="ladda-button btn btn-warning btn-sm button_normal" data-style="expand-right">Small
                                                </button>
                                            </div>
                                            <div class="col-md-4">
                                                <button class="ladda-button btn btn-warning btn-xs button_normal" data-style="expand-right">Extra Small
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <button class="ladda-button btn btn-success button_progress" data-style="expand-right">Expand-right
                                                </button>
                                            </div>
                                            <div class="col-md-5">
                                                <button class="ladda-button btn btn-success button_progress" data-style="contract">contract
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="example example-buttons">
                                        <button type="button" class="btn btn-icon btn-default m-r-50"><i class="icon fa fa-fw ti-location-pin" aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-icon btn-primary m-r-50"><i class="icon fa fa-fw ti-layout-grid3" aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-icon btn-success m-r-50"><i class="icon fa fa-fw ti-bell" aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-icon btn-info m-r-50"><i class="icon fa fa-fw ti-calendar" aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-icon btn-warning btn-round m-r-50"><i class="icon fa fa-fw ti-time" aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-icon btn-danger btn-round m-r-50"><i class="icon fa fa-fw ti-flag-alt-2" aria-hidden="true"></i>
                                        </button>
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div class="example-wrap">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-animate btn-animate-vertical btn-success m-r-50">
