                                                    ...
                                                    <div>
                                                        <div class="row">
                                                            <div class="col-sm-offset-3 col-sm-9">
                                                                ...
                                                                &nbsp;
                                                                <button type="button" class="btn btn-danger m-t-10">Cancel
                                                                </button>
                                                                &nbsp;
                                                                <button type="reset" class="btn btn-default bttn_reset m-t-10">
                                                                    Reset
                                                                </button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-sm-offset-3 col-sm-9">
                                                                ...
                                                                &nbsp;
                                                                <button type="reset" class="btn btn-default m-t-10 bttn_reset">
                                                                    Reset
                                                                </button>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="panel ">
                                            ...
                                            <div class="panel-body">
                                                <form action="#">
                                                    <div>
                                                        <button type="button" class="btn btn-primary m-t-10">Submit</button>
                                                        &nbsp;
                                                        <button type="button" class="btn btn-danger m-t-10">Cancel</button>
                                                        &nbsp;
                                                        <button type="reset" class="btn btn-default bttn_reset m-t-10">Reset
                                                        </button>
                                                    </div>
                                                    <div class="form-body">
                                                        <div class="form-group m-t-10">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-sm-offset-3 col-sm-9">
                                                                    <label class="checkbox-inline">
                                                                        ...
                                                                        <a href="#" class="forgot">Terms and Conditions</a> .
                                                                    </label>
                                                                </div>
                                                            </div>
