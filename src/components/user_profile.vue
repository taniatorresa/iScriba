                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="text-center mbl m-t-10">
                                    <img src="../assets/img/authors/avatar1.jpg" alt="img" class="img-circle img-bor" />
                                </div>
                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="img">
                                                                <a href="javascript:void(0)">
                                                                    <img class="media-object thumbnail img-responsive" height="60" width="60" src="../assets/img/authors/avatar2.jpg" alt="avatar image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="details">
                                                                <div class="name">
                                                                    <a href="javascript:void(0)">Scarlett Johansson</a>
                                                                </div>
                                                                <div class="time">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-6 bord">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="img">
                                                                <a href="javascript:void(0)">
                                                                    <img class="media-object thumbnail img-responsive" src="../assets/img/authors/avatar.jpg" alt="avatar image" height="60" width="60">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="details">
                                                                <div class="name">
                                                                    <a href="javascript:void(0)">Mila Kunis</a>
                                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-6 bord">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="img">
                                                                <a href="javascript:void(0)">
                                                                    <img class="media-object thumbnail img-responsive" src="../assets/img/authors/avatar4.jpg" alt="avatar image" height="60" width="60">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="details">
                                                                <div class="name">
                                                                    <a href="javascript:void(0)">Ryan Gossling</a>
                                                                </div>
                                                                <div class="time online">
                                                                    <i class="icon-check icons"></i> Online
                                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-6 bord">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="img">
                                                                <a href="javascript:void(0)">
                                                                    <img class="media-object thumbnail img-responsive" src="../assets/img/authors/avatar3.jpg" alt="avatar image" height="60" width="60">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="details">
                                                                <div class="name">
                                                                    <a href="javascript:void(0)">Robert Downey Jr.</a>
                                                                </div>
                                                                <div class="time">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-6 bord">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="img">
                                                                <a href="javascript:void(0)">
                                                                    <img class="media-object thumbnail img-responsive" src="../assets/img/authors/avataraa.jpg" alt="avatar image" height="60" width="60">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="details">
                                                                <div class="name">
                                                                    <a href="javascript:void(0)">Emma Watson</a>
                                                                </div>
                                                                <div class="time">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-6 bord">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="img">
                                                                <a href="javascript:void(0)">
                                                                    <img class="media-object thumbnail img-responsive" src="../assets/img/authors/avatar7.jpg" alt="avatar image" height="60" width="60">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="details">
                                                                <div class="name">
                                                                    <a href="javascript:void(0)">George Clooney</a>
                                                                </div>
                                                                <div class="time">
                                            ...
                                            <div class="events">
                                                ...
                                                <div class="row m-t-l-10">
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">Lorem Ipsum is simple</a>
                                                                    </h4>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar2.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">Lorem ipsum dolor text</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                                        Los Angeles, CA
                                                    ...
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar3.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">Lorem Ipsum is not simply random
                                                                            text</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar4.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">The standard chunk of Lorem
                                                                            Ipsum</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                ...
                                                <div class="row m-t-l-10">
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar5.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">There are many variations</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                                        Silicon Valley, San Francisco, CA
                                                    ...
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar6.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">There are many variations of
                                                                            passages</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avatar7.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">English. Many desktop publishing</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                                        Los Angeles, CA
                                                    ...
                                                    <div class="col-sm-12 col-md-12 bord">
                                                        <div class="media">
                                                            <a class="pull-left" href="javascript:void(0)">
                                                                <img class="media-object thumbnail" src="../assets/img/authors/avataraa.jpg" alt="image" height="80" width="80" />
                                                            </a>
                                                            <div class="media-body">
                                                                <h4 class="event-title">
                                                                        <a href="javascript:void(0)">Lorem Ipsum comes from sections</a>
                                                                    </h4>
                                                                <small class="text-muted">
                                                                        <i class="icon-location-pin icons"></i>
                                                                        Bay Area, San Francisco
